...
class Grid(Base):
    ...
    def add(
        ...
        if not self._option:
            ...
            print("-+++++++++",self._js_dependencies,self._option.get("geo")) 
            _grid = grid(
                grid_width,
                grid_height,
                grid_top,
            ...
            if chart._option.get("geo"):
                self._option.update(geo=chart._option.get("geo"))
            ...
            #print("--------",chart.js_dependencies,chart._option.get("geo")) 
            if chart._option.get("geo"):
                self._option.update(geo=chart._option.get("geo"))
            for s in _series[0]:
